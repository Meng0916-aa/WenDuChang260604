...
`evaluated_not_finalized`. The ROI evaluation is complete. The evaluation
...
core, 0 clipped frames). Formal ROI generation remains closed and waits for
explicit user confirmation. Formal feature extraction also remains closed.
